...
public class Main {
    ...
    public static int metodo1(int x) { //Variable de entrada x
    ...
    public void metodo2(int x) { //Variable de entrada x
        ...
        for (i = 1; i < x; i++) {// O(1) Iteración lineal comenzando por el valor 1 hasta el valor de entrada (con valor de entrada negativo no entra)
